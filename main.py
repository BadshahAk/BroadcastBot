...
async def startprivate(client, message):
    ...
    joinButton = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/sl_Toons"),
                InlineKeyboardButton(
                    "SUPPORT GROUP", url="https://t.me/SL_Toon"
                ),
            ]
        ]
    )
    welcomed = f"Hey <b>{message.from_user.first_name}</b>\nI'm a simple Telegram bot that can broadcast messages and media to the bot subscribers. Made by @SL_MGx03.\n\n 🎚 use /settings"
